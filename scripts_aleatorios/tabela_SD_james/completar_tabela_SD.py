...
def escreve_string(produto, contador_combinacao_produto, acab, estofaria=False, faixa_tecido=''):
    ...
    string_pt2 += ('|' + produto.nome_produto + ' ' + acab + ' ' + faixa_tecido + string_estofaria + produto.caracteristica_produto + \
    ...
    print('escreve_string:\t', string_linha)
    return string_linha
    ...
    if lamina_nogueira:
        if tem_estofaria:
            for faixa in faixa_tecidos:
                ...
                tabela_produtos_novos += escreve_string(produto, contador_combinacao_produto, acab, True, faixa)
                contador_combinacao_produto += 1
        else:
            acab = acabamento_nogueira
            tabela_produtos_novos += escreve_string(produto, contador_combinacao_produto, acab, True)
            contador_combinacao_produto += 1
        ...
        if tem_estofaria:
            ...
            for acab in acabamentos:
                tabela_produtos_novos += escreve_string(produto, contador_combinacao_produto, acab)
                contador_combinacao_produto += 1
